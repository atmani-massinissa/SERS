...
public class Principale {
	public static void main(String[] args) throws Exception {
		 ...
		 * analyseurDeTest.analyserParMc(); analyseurDeTest.displayResults();
		 */

		/*
		 * fetchPatrons ("PatternsParLem.txt"); Analyseur analyseurDeTest=new
		 * Analyseur("Dépression (psychiatrie).txt");
		 ...
		 * Analyseur("Dépression (psychiatrie).txt");
		 * analyseurDeTest.analyserParLemMc(); analyseurDeTest.displayResults();
		 */
	}
	...
	public static void fetchPatrons(String filePath) throws IOException {
		...
		// System.out.println("Types de relations définis:
		// "+Relation.types_de_relations);
